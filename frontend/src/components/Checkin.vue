  ...
  <div class="bg-gray-100 mx-auto max-w-lg p-6 rounded-2xl border border-gray-300 shadow-xl/50 shadow-gray-400">
    <form @submit.prevent="handleSubmit">
      ...
      <div class="mb-5">
        ...
        <textarea id="reportNotes" v-model="form.reportNotes" rows="4" placeholder="Detail kunjungan, diskusi, dan hasil." required
      ...
      <div class="mb-5">
        ...
        <textarea type="text" rows="4" id="equipmentNeed" v-model="form.equipmentNeed" placeholder="Contoh: Mesin Bor, Genset" required
      ...
      <div class="mb-5">
        ...
        <textarea rows="4" type="text" id="preorderItem" v-model="form.preorderItem" placeholder="Contoh: 100 unit Genset" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition duration-200"></textarea>
     </div>
      ...
      <div class="mb-5">
        ...
        <div class="flex flex-col lg:flex-row items-center gap-2">
          <input type="text" id="coordinateLocation" v-model="form.coordinate" placeholder="Latitude, Longitude" required readonly
