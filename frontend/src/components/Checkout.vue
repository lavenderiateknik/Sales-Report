  ...
  <div class="bg-gray-100 mx-auto max-w-lg p-6 rounded-2xl border border-gray-300 shadow-xl my-2">
    <form @submit.prevent="updateForm" enctype="multipart/form-data" class="space-y-4">
      ...
      <div>
        ...
        <input type="text" v-model="form.project_name" class="w-full px-3 py-2 border border-gray-300 rounded-md" readonly />
      </div>

      <div class="grid grid-cols-2 gap-3">
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-1">PIC Name</label>
          <input type="text" v-model="form.pic_name" placeholder="Nama PIC" class="px-3 py-2 border rounded-md" readonly/>
        </div>
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-1">PIC Phone</label>
          <input type="text" v-model="form.pic_phone" placeholder="Telp PIC" class="px-3 py-2 border rounded-md"readonly />
        </div>
      </div>
      <label class="block text-sm font-medium text-gray-700 mb-1">PIC Positition</label>
      <input type="text" v-model="form.pic_position" placeholder="Posisi PIC" class="w-full px-3 py-2 border rounded-md" readonly />
